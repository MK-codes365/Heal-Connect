...
const About = () => {
    return (
        <div style={{ padding: '8rem 2rem', maxWidth: '800px', margin: '0 auto', color: '#e2e8f0' }}>
            <h1 style={{ fontSize: '3rem', marginBottom: '2rem', color: '#38bdf8' }}>About SRTA</h1>
            <p style={{ fontSize: '1.2rem', lineHeight: '1.8', marginBottom: '1.5rem' }}>
                At <strong>Smart Rural TeleHealth Assistant (SRTA)</strong>, we believe that quality healthcare should be accessible to everyone, regardless of where they live. Our mission is to bridge the gap between rural communities and specialized medical care using cutting-edge artificial intelligence and seamless video connectivity.
            </p>
